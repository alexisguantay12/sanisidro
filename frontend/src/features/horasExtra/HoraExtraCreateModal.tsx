...
export default function HoraExtraCreateModal({
  ...
  const [peonId, setPeonId] = useState<number | null>(null);
  const [fecha, setFecha] = useState("");
  const [horas, setHoras] = useState(1);
  const [motivo, setMotivo] = useState<MotivoHoraExtra>("riego");
          ...
          <div className="min-h-0 flex-1 space-y-6 overflow-y-auto p-5">
            <div>
              ...
              <select
                ...
                disabled={loading}
                className="h-12 w-full rounded-xl border border-[#E0E5E1] bg-white px-4 text-[#303632] outline-none transition focus:border-[#18392B] focus:ring-4 focus:ring-[#18392B]/5 disabled:bg-slate-50"
              >
                <option value="">
