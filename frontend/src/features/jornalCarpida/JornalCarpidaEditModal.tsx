...
export default function JornalCarpidaEditModal({
  open,
  jornal,
  onClose,
  onSuccess,
      ...
      <div className="max-h-[92vh] w-full overflow-y-auto rounded-t-[28px] bg-white shadow-2xl sm:max-w-lg sm:rounded-[28px]">
        ...
        <div className="flex items-start justify-between border-b border-[#EEF1EF] px-5 py-5 sm:px-6">
          ...
          <button
            ...
            onClick={onClose}
            disabled={loading}
            className="flex h-10 w-10 items-center justify-center rounded-xl text-[#8A938D] transition hover:bg-[#F4F6F4]"
          >
            <X size={20} />
          </button>
        ...
        >
          ...
          <div className="mt-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <p className="mt-1 text-xs text-[#7D8680]">
                  Dos jornales
                </p>
              </button>
          ...
          <div className="mt-5">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-2xl border border-[#DDE3DF] bg-[#FAFBFA] px-4 py-3 text-sm outline-none placeholder:text-[#A3AAA5] focus:border-[#9FB4A6] focus:bg-white focus:ring-4 focus:ring-[#18392B]/5"
            />
          ...
          <div className="mt-5 rounded-2xl bg-[#F5F7F5] p-4">
            ...
            <p className="text-xs font-medium leading-5 text-[#778079]">
              Si modificás la fecha o el tipo de jornada,
              el importe será recalculado automáticamente.
            </p>
          ...
          <div className="mt-6 flex gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="h-12 flex-1 rounded-2xl bg-[#18392B] px-4 text-sm font-semibold text-white transition hover:bg-[#204A38] disabled:opacity-60"
            >
              {loading
                ? "Guardando..."
                : "Guardar cambios"}
