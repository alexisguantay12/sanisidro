...
import { updateConfiguracionPaleadaActual} from "./api";
...
export default function ValorPaleadaModal({
  open,
  valorActual,
  onClose,
  onSuccess,
  ...
  async function handleSubmit(
    ...
    try {
      ...
      await updateConfiguracionPaleadaActual(
        numero
      );
      ...
      <div className="w-full rounded-t-[28px] bg-white shadow-2xl sm:max-w-md sm:rounded-[28px]">
        ...
        <div className="flex items-start justify-between border-b border-black/5 px-5 py-5">
          ...
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-xl text-[#747D77] transition hover:bg-[#F3F5F3] disabled:opacity-50"
          >
          ...
          <div className="space-y-5 p-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="45000"
                className="h-12 w-full rounded-2xl border border-[#DDE3DF] px-4 text-sm outline-none transition focus:border-[#9FB4A6] focus:ring-4 focus:ring-[#18392B]/5"
              />


              <p className="mt-2 text-xs leading-5 text-[#8B948E]">
                Este valor se utilizará
                al liquidar tarjas cuya
                tarea sea Paleada.
              </p>
          ...
          <div className="border-t border-black/5 px-5 pt-3 pb-[calc(env(safe-area-inset-bottom)+16px)] sm:pb-5">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="h-12 flex-1 rounded-2xl bg-[#18392B] text-sm font-semibold text-white transition hover:bg-[#102C21] disabled:opacity-50"
              >
